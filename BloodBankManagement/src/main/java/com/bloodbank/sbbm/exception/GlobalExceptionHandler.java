...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler{
	...
	public ResponseEntity<ErrorMessage> handleUserEmailException(
			UserEmailNotFoundException ex, WebRequest request){
		ErrorMessage em = new ErrorMessage(HttpStatus.NOT_FOUND, ex.getMessage());
		return ResponseEntity.status(HttpStatus.NOT_FOUND).body(em);
	}
	
	@ExceptionHandler(PasswordNotFoundException.class)
	public ResponseEntity<ErrorMessage> handlePasswordException(
